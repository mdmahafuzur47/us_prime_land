...
export default function SearchPropertiesLand() {
  return (
    <>
      <div className="bg-[#9fdbff] py-10 rounded-2xl shadow flex flex-col w-full  items-center">
        ...
        <h1 className="text-2xl md:text-4xl mb-8 mt-3 font-semibold">
          Explore Lands from Quick Search
        </h1>

        <div className="w-full px-5 flex gap-2">
          <div className="searchInput bg-white flex items-center w-full">
            <input
